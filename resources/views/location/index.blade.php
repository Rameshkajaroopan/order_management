        ...
        <table id="zero_config" class="table rwd-table table table-striped table table-hover table table-striped table-bordered no-wrap fixed table table-striped table-bordered no-wrap fixed">
          ...
          <tr id="{{$location->id}}">
            ...
            <td data-th="Actions">
              ...
              <button type="button" class="btn btn-secondary deletebutton" data-id="{{$location->id}}">Delete</button>
...
<div id="viewModal" class="modal  fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-3">
      <form id="form" action="{{route('location.update')}}" method="post">
        @csrf
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input id="location_name" name="name" type="text" class="form-control modelView" value="" required />
                  </div>
                </div>
